...
We calibrated a Generalized Linear Model for our dataset in line with the specified requirements. Moreover, we projected the model over the selected period to illustrate the value of our dataset in biogeographical history studies.
...
![Figure 3. SDM Animation](figures/a4/glm_timeseries.gif)
...
```
 ...
 ![Figure 4. SDM over threshold](figures/a4/th_map.png){width="631"}
